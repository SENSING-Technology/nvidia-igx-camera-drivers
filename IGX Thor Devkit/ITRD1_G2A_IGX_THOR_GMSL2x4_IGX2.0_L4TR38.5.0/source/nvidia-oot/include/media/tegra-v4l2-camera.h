...
#define TEGRA_CAMERA_CID_SET_DGAIN_ID		(TEGRA_CAMERA_CID_BASE + 131)
#define TEGRA_CAMERA_CID_TRIG_PIN_ID		(TEGRA_CAMERA_CID_BASE + 132)
#define TEGRA_CAMERA_CID_TRIG_MODE_ID		(TEGRA_CAMERA_CID_BASE + 133)
#define TEGRA_CAMERA_CID_GMSL_MODE_ID		(TEGRA_CAMERA_CID_BASE + 134)
#define TEGRA_CAMERA_CID_MIRROR_ID		    (TEGRA_CAMERA_CID_BASE + 135)
#define TEGRA_CAMERA_CID_FLIP_ID		    (TEGRA_CAMERA_CID_BASE + 136)
